    ...
    <div className='w-[98vw] ml-2 sm:w-full h-screen flex md:pl-10'>
      <div className='w-full sm:w-[60vw] h-screen py-7 px-4 flex flex-col '>
        ...
        <div className=' md:h-[65vh] w-full py-5 px-4 flex flex-col gap-2'>
          ...
          <h5 className='text-[5vw] font-semibold tracking-wide md:text-sm'>
          ...
          >
            ...
            <button
              ...
              } duration-500 py-2 mt-7 rounded-lg text-white font-bold tracking-[3px] md:w-[41vw]`}
            >
      ...
      <div className='signin1 lg:w-[80vw] h-screen'></div>
    </div>
  );
}
