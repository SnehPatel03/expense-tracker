...
function IncomeOverview({ transaction, onAddIncome }) {
  ...
  return (
    <div className='w-full sm:w-[70vw] mt-6 ml-6'>
      ...
      <div className='flex justify-between text-gray-800 items-center w-[90vw] mt-4 p-3 ml-2 pr-3 h-13 bg-gray-200/55 border-gray-100 shadow-gray-400 rounded-xl sm:w-[74vw] sm:h-[13vh] sm:pr-2'>
        ...
        <button
        onClick={onAddIncome}
          className='flex justify-center text-gray-800 items-center bg-gray-100 text-[0.9vw] font-extrabold tracking-wide hover:text-purple-700  border-gray-300/50 rounded-xl mr-2 py-2 px-3 hover:bg-purple-200 duration-700'
        >
          ADD INCOME
          <LuPlus className='ml-2 mb-0.5 text-sm' />
        </button>
      </div>
