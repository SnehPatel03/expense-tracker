...
function Last30DaysExpense({ data }) {
    ...
    return (
        <div className='ml-10 mt-6.5'>
            <div className='flex justify-between text-gray-800 items-center w-[85vw]  mt-3 p-3 ml-2  h-13 bg-gray-200/55 border-gray-100 shadow-gray-400 rounded-xl sm:w-[34vw] sm:h-[10vh] sm:pr-2'>
