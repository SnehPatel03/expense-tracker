...
import <TransactionInfoCard></TransactionInfoCard> from './TransactionInfoCard';
import moment from 'moment';

function IncomeTrsansaction({ transactions = [], onseeMore }) {
  return (
...
export default IncomeTrsansaction;
