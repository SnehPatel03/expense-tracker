...
import TransactionInfoCardIncome from './TransactionInfoCardIncome';
import moment from 'moment';

function TransactionInfoCardIncome({ transactions = [], onseeMore }) {
  return (
...
export default <IncomeTransaction></IncomeTransaction>;
